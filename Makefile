...
LIST_BONUS = ft_calloc.c ft_strjoin.c ft_ra.c ft_rb.c ft_rr.c ft_pa.c ft_pb.c ft_sa.c ft_sb.c ft_ss.c ft_rra.c ft_rrb.c ft_rrr.c checker.c ft_is_sorted.c ft_printf.c ft_putchar.c ft_putnbr_fd.c ft_split_atoi.c ft_strlen.c ft_plus_first.c ft_minus_first.c 
...
fclean:clean
	@rm $(NAME) $(PROGRAM) $(NAME_BONUS) $(PROGRAM_BONUS)
