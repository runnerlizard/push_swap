...
LIST =	ft_replace.c ft_count_argv.c ft_sb.c ft_rb.c ft_rrb.c ft_sort_many_add.c ft_plus_first.c ft_minus_first.c ft_split_atoi.c ft_printf.c ft_putchar.c ft_putnbr_fd.c push_swap.c ft_is_sorted.c ft_sort.c ft_print_stack.c ft_sort_four.c ft_sort_three.c ft_sort_many.c ft_sort_two.c ft_nearest.c ft_pa.c ft_pb.c ft_ra.c ft_rra.c ft_sa.c ft_strjoin.c ft_strlen.c ft_calloc.c 

LIST_BONUS = ft_replace.c ft_count_argv.c ft_memcmp.c ft_calloc.c ft_strjoin.c ft_sb.c ft_ra.c ft_rb.c ft_rr.c ft_pa.c ft_pb.c ft_sa.c ft_ss.c ft_rra.c ft_rrb.c ft_rrr.c checker.c ft_is_sorted.c ft_printf.c ft_putchar.c ft_putnbr_fd.c ft_split_atoi.c ft_strlen.c ft_plus_first.c ft_minus_first.c 
